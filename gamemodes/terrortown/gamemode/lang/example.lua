...
--[[
how to use:
1. change LANG.CreateLanguage("[Your Language]")
2. change all Strings to your translation
3. Please save file in [your_language].lua
]]

local L = LANG.CreateLanguage("Example")
